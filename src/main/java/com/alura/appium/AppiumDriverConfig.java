...
import java.net.URL;
    ...
    private static AppiumDriverConfig _instance;
        ...
        public static AppiumDriverConfig Instance(){
            if(AppiumDriverConfig._instance == null) AppiumDriverConfig._instance = new AppiumDriverConfig();
            return AppiumDriverConfig._instance;
        }

        private AppiumDriverConfig() {
            File apk = new File("C:\\Users\\marina.rodrigues\\IdeaProjects\\AluraAppium\\src\\main\\resources\\alura_esporte.apk");
